...
export default function OrphanageInfoCard({ orphanageInfo }: Props) {
  return (
    <View style={styles.card}>
      ...
      <View style={styles.infoRow}>
        ...
        <Text style={styles.value}>{orphanageInfo.phone}</Text>
      </View>
      
      <View style={styles.infoRow}>
        <Text style={styles.label}>Email:</Text>
        <Text style={styles.value}>{orphanageInfo.email}</Text>
      </View>
